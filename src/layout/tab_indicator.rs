...
pub struct TabIndicator {
    ...
    config: tiri_config::TabIndicator,
}
...
impl TabIndicator {
    pub fn new(config: tiri_config::TabIndicator) -> Self {
        Self {
            shader_locs: Vec::new(),
            shaders: Vec::new(),
            open_anim: None,
    ...
    pub fn update_config(&mut self, config: tiri_config::TabIndicator) {
        self.config = config;
    }
    ...
    pub fn start_open_animation(&mut self, clock: Clock, config: tiri_config::Animation) {
    ...
    pub fn config(&self) -> tiri_config::TabIndicator {
        self.config
    }
}
