...
impl Animation {
    ...
    pub fn replace_config(&mut self, config: tiri_config::Animation) {
        ...
        match config.kind {
            tiri_config::animations::Kind::Spring(p) => {
            ...
            tiri_config::animations::Kind::Easing(p) => {
                *self = Self::ease(
                    self.clock.clone(),
                    self.from,
                    self.to,
...
impl From<tiri_config::animations::Curve> for Curve {
    fn from(value: tiri_config::animations::Curve) -> Self {
        match value {
            tiri_config::animations::Curve::Linear => Curve::Linear,
            tiri_config::animations::Curve::EaseOutQuad => Curve::EaseOutQuad,
            tiri_config::animations::Curve::EaseOutCubic => Curve::EaseOutCubic,
            tiri_config::animations::Curve::EaseOutExpo => Curve::EaseOutExpo,
            tiri_config::animations::Curve::CubicBezier(x1, y1, x2, y2) => {
