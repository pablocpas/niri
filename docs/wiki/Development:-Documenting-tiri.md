tiri's documentation files are found in `docs/wiki/` and should be viewable and browsable in at least three systems:

- The GitHub repo's markdown file preview
- [The GitHub repo's wiki](https://github.com/pablocpas/tiri/wiki)
- [The documentation site](https://pablocpas.github.io/tiri/)
...
The documentation site should now be available on http://127.0.0.1:8000/tiri/
